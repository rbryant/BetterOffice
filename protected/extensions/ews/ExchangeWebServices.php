...
class ExchangeWebServices
{
    ...
    public function __construct(
        ...
        //$this->registerScripts($loaded);
    }

        
    public function registerScripts($loaded) {
    	
       	require dirname(__FILE__).'\EWSType\FindItemType.php';
       	require dirname(__FILE__).'\EWSType\ItemResponseShapeType.php';
       	require dirname(__FILE__).'\EWSType\ItemQueryTraversalType.php';
       	require dirname(__FILE__).'\EWSType\DefaultShapeNamesType.php';
       	require dirname(__FILE__).'\EWSType\CalendarViewType.php';
       	require dirname(__FILE__).'\EWSType\NonEmptyArrayOfBaseFolderIdsType.php';
       	require dirname(__FILE__).'\EWSType\DistinguishedFolderIdType.php';
       	require dirname(__FILE__).'\EWSType\DistinguishedFolderIdNameType.php';

       	require dirname(__FILE__).'\NTLMSoapClient\Exchange.php';
