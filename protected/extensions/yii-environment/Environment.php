 ...
 *
 * // set environment
 * require_once(dirname(__FILE__) . '/protected/extensions/yii-environment/Environment
 * {{{
 * <?php.php');
 * $env = new Environment();
...
class Environment
{
	...
	{
		echo '<div style="position: absolute; bottom: 0; left: 0; z-index: 99999; height: 850px; overflow: auto; background-color: #ddd; color: #000; border: 1px solid #000; margin: 5px; padding: 5px;">
