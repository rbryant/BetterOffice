    ...
    */
    RGraph.Pie.prototype.getRadius = function ()
    {
        ...
        this.graph        = {};
        this.graph.width  = ca.width - prop['chart.gutter.left'] - prop['chart.gutter.right'];
        this.graph.height = ca.height - prop['chart.gutter.top'] - prop['chart.gutter.bottom'];
            ...
            */
            if (prop['chart.highlight.style'] == '3d') {
                ...
                co.beginPath();
                    ...
                    co.fillStyle   = this.properties['chart.colors'][shape['index']];
                    co.strokeStyle = this.properties['chart.strokestyle'];
