    ...
    RGraph.Line.prototype.DrawAxes = function ()
    {
        ...
        if (prop['chart.noxaxis'] == false) {
            if (prop['chart.xaxispos'] == 'center') {
                ...
                co.lineTo(ca.width - this.gutterRight, this.canvas.height - this.gutterBottom);
            }
        }
            ...
            */
                ...
                if ((prop['chart.ymin'] != 0 || prop['chart.noxaxis']) || prop['chart.scale.invert']) {
                    RG.Text2(this, {'font':font,
                                    ...
                                    'text': (prop['chart.ymin'] != 0 ? '-' : '') + RGraph.number_format(this, prop['chart.ymin'].toFixed(decimals), units_pre, units_post),
                                    'valign':'center',
                                    'halign': align,
                                    'bounding':bounding,
                                    'boundingFill':bgcolor,
    ...
    */
    RGraph.Line.prototype.Adjusting_mousemove = function (e)
    {
        ...
        */
        if (RG.Registry.Get('chart.adjusting') && RG.Registry.Get('chart.adjusting').uid == this.uid) {
    ...
    */
    RGraph.Line.prototype.parseColors = function ()
    {
        ...
        * Key colors
        */
        if (!RGraph.is_null(prop['chart.key.colors'])) {
