...
class SocialController extends CController
{
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Social #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"social-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Social"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"social-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Social']))
		{
                       ...
                       if (!empty($model->account)) $criteria->addCondition('account = "'.$model->account.'"');
                 ...
                 $session['Social_records']=Social::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Social_records']))
               {
                $model=$session['Social_records'];
               }
               else
                 $model = Social::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Social Report');
		$pdf->SetSubject('Social Report');
