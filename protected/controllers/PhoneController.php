...
class PhoneController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Phone #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"phone-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Phone"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"phone-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Phone']))
		{
                       ...
                       if (!empty($model->number)) $criteria->addCondition('number = "'.$model->number.'"');
                 ...
                 $session['Phone_records']=Phone::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Phone_records']))
               {
                $model=$session['Phone_records'];
               }
               else
                 $model = Phone::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Phone Report');
		$pdf->SetSubject('Phone Report');
