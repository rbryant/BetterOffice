...
class TaskController extends CController
{
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Task #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"task-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
		    if(isset($_POST['Task']))
		    {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Task"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"task-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Task']))
		{
                 ...
                 $session['Task_records']=Task::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Task_records']))
               {
                $model=$session['Task_records'];
               }
               else
