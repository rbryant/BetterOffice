...
class CatalogController extends CController
{
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Catalog #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"catalog-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Catalog"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"catalog-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Catalog']))
		{
                       ...
                       if (!empty($model->catalog)) $criteria->addCondition('catalog = "'.$model->catalog.'"');
                     
                    			
		}
                 $session['Catalog_records']=Catalog::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Catalog_records']))
               {
                $model=$session['Catalog_records'];
               }
               else
                 $model = Catalog::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Catalog Report');
		$pdf->SetSubject('Catalog Report');
