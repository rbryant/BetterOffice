...
class WebsitesController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Websites #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"websites-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Websites"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"websites-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Websites']))
		{
                 ...
                 $session['Websites_records']=Websites::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Websites_records']))
               {
                $model=$session['Websites_records'];
               }
               else
                 $model = Websites::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Websites Report');
		$pdf->SetSubject('Websites Report');
