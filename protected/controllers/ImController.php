...
class ImController extends CController
{
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Im #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"im-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
		    if(isset($_POST['Im']))
		    {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Im"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"im-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Im']))
		{
                 ...
                 $session['Im_records']=Im::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Im_records']))
               {
                $model=$session['Im_records'];
               }
               else
                 $model = Im::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Im Report');
		$pdf->SetSubject('Im Report');
