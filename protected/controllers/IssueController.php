...
class IssueController extends CController
{
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Issue #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"issue-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Issue"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"issue-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Issue']))
		{
                       ...
                       if (!empty($model->assignedto)) $criteria->addCondition('assignedto = "'.$model->assignedto.'"');
                       ...
                       if (!empty($model->due_date)) $criteria->addCondition('due_date = "'.$model->due_date.'"');
                     
                    			
		}
                 $session['Issue_records']=Issue::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Issue_records']))
               {
                $model=$session['Issue_records'];
               }
               else
                 $model = Issue::model()->findAll();
