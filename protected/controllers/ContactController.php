...
class ContactController extends CController
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','leads'),
				'users'=>array('*'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','GeneratePdf','GenerateExcel', 'MyLeads'),
				'users'=>array('*'),
			),
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Contact #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"contact-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Contact"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"contact-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Contact']))
		{
                       ...
                       if (!empty($model->company_id)) $criteria->addCondition('company_id = "'.$model->company_id.'"');
                 ...
                 $session['Contact_records']=Contact::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Contact_records']))
               {
                $model=$session['Contact_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Contact Report');
		$pdf->SetSubject('Contact Report');
