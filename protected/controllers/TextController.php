...
class TextController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Text #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"text-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
		    if(isset($_POST['Text']))
		    {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Text"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"text-update-form");
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Text']))
		{
                       ...
                       if (!empty($model->text)) $criteria->addCondition('text = "'.$model->text.'"');
                     
                    	
                       if (!empty($model->ref)) $criteria->addCondition('ref = "'.$model->ref.'"');
                 ...
                 $session['Text_records']=Text::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Text_records']))
               {
                $model=$session['Text_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Text Report');
		$pdf->SetSubject('Text Report');
