...
class EmailController extends CController
{
	...
	public function actionView()
	{
		...
		$this->widget('bootstrap.widgets.TbButton', array(
		 ...
		 echo "<div class='printableArea'>";
	         echo "<h1>View Email #".$model->id."</h1><hr />";
	...
	{	
		...
		$this->performAjaxValidation($model,"email-create-form");
            if(Yii::app()->request->isAjaxRequest)
	       {
	...
	public function actionUpdate()
	{
	    ...
	    $id=isset($_REQUEST["id"])?$_REQUEST["id"]:$_REQUEST["Email"]["id"];
	    $model=$this->loadModel($id);
			    
	    // Uncomment the following line if AJAX validation is needed
	      $this->performAjaxValidation($model,"email-update-form");
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Email Report');
		$pdf->SetSubject('Email Report');
