    <div id='social-update-modal' class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'social-update-form',
	'enableAjaxValidation'=>true,
        'enableClientValidation'=>true,
        'method'=>'post',
        'action'=>array("social/update"),
	'type'=>'horizontal',
	'htmlOptions'=>array(
