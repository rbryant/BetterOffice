    ...
    <div id='social-create-modal' class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <?php
	...
	'id'=>'social-create-form',
	'enableAjaxValidation'=>true,
        'enableClientValidation'=>true,
        'method'=>'post',
        'action'=>array("social/create"),
	'type'=>'horizontal',
	'htmlOptions'=>array(
...
function create()
 {
   ...
   var data=$("#social-create-form").serialize();
  ...
  $.ajax({
   type: 'POST',
    url: '<?php
 echo Yii::app()->createAbsoluteUrl("social/create"); ?>',
   data:data,
success:function(data){
                //alert("succes:"+data); 
                if(data!="false")
                 {
                  $('#social-create-modal').modal('hide');
                  renderView(data);
...
{
  $('#social-create-form').each (function(){
  this.reset();
   });
