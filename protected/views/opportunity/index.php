...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('grid-opportunity-grid', {
        data: $(this).serialize()
    });
    return false;
});
                ...
                <div class="span9">
                    <div class="pull-left">
                        <div class="container-fluid">
                            <h1 class="oro-subtitle">Opportunities</h1>
                        </div>
                    </div>
                <div></div></div>
...
function delete_record(id)
{
 ...
 var data="id="+id;
  ...
  $.ajax({
   type: 'POST',
    url: '<?php echo Yii::app()->createAbsoluteUrl("opportunity/delete"); ?>',
   data:data,
