    ...
    <div id='phone-create-modal' class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
function create()
 {
   ...
   var data=$("#phone-create-form").serialize();
  ...
  $.ajax({
   type: 'POST',
    url: '<?php
 echo Yii::app()->createAbsoluteUrl("phone/create"); ?>',
   data:data,
success:function(data){
                //alert("succes:"+data); 
                if(data!="false")
                 {
                  $('#phone-create-modal').modal('hide');
                  renderView(data);
...
{
  $('#phone-create-form').each (function(){
  this.reset();
   });
