...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('grid-cronjob-grid', {
        data: $(this).serialize()
    });
    return false;
});
                ...
                <div class="span9">
                    <div class="pull-left">
                        <div class="container-fluid">
                            <h1 class="oro-subtitle">Cronjobs</h1>
                        </div>
                    </div>
                <div></div></div>
        ...
        <?php  $this->widget('yiiwheels.widgets.grid.WhGridView',array(
                ...
                'columns'=>array(
                            array(
                                        ...
                                        'url' => 'Yii::app()->createUrl("cronjob/view", array("id"=>$data->id))',
                                        ),
                                        ),
                                        ),		'executed_at',
		'succeeded',
...
function delete_record(id)
{
 ...
 var data="id="+id;
  ...
  $.ajax({
   type: 'POST',
    url: '<?php echo Yii::app()->createAbsoluteUrl("cronjob/delete"); ?>',
   data:data,
