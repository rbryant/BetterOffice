	...
	'columns'=>array(
		...
		'log',
            ...
            array('htmlOptions' => array('nowrap'=>'nowrap'),
                ...
                'viewButtonUrl'=>'Yii::app()->createUrl("/worklog/view/", array("id"=>$data["id"]))',
                'updateButtonUrl'=>'Yii::app()->createUrl("/worklog/update/", array("id"=>$data["id"]))',
                'deleteButtonUrl'=>'Yii::app()->createUrl("/worklog/view/", array("id"=>$data["id"]))',
            ),
...
function delete_record(id)
{
 ...
 var data="id="+id;
  ...
  $.ajax({
   type: 'POST',
    url: '<?php echo Yii::app()->createAbsoluteUrl("worklog/delete"); ?>',
   data:data,
