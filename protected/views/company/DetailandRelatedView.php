...
$history->push(null, $model->name, 'icon-globe');
		...
		$contactData=Yii::app()->db->createCommand("SELECT * FROM contact where company ='".$model->id."'")->queryAll();
...
<div class="container-fluid">
    ...
    <div class="span8">
        <h3><?php echo $model->name;?></h3>
            ...
            <textarea cols="400" id="company_background" name="company[background]" rows="2" style="width:500px">
