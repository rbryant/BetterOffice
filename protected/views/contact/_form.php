...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
   ...
   <div class="control-group">		
	...
	<?php echo $form->dropDownListRow(
	                    $model,
	                    'company_id', 
	                    CHtml::listData(company_id::model()->findAll(array('order'=>'name')),
		                    'id', 
		                    'name'), 
						array('empty'=>'Select Value')); ?>

	<?php echo $form->html5EditorRow($model,'description',array('rows'=>6, 'cols'=>50, 'class'=>'span8', 'options'=>array('color'=>true))); ?>
